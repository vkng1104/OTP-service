...
const OTPSystemABI = __importStar(require("../artifacts/contracts/OTPSystem.sol/OTPSystem.json")); // Import the ABI from the JSON file
...
const contract = new ethers_1.ethers.Contract(CONTRACT_ADDRESS, OTPSystemABI.abi, signer);
